...
void main() {
  ...
  group('User authentication', () {
    ...
    test('signUp should create user when successful', () async {
      ...
      when(mockUserService.createUser(any)).thenAnswer((_) async => null);
    ...
    test('signOut should clear user data', () async {
      // Arrange
      when(mockUserService.signOut()).thenAnswer((_) async => null);
  ...
  group('User profile management', () {
    ...
    test('updateUserProfile should update user properties', () async {
      // Arrange
      when(
        mockUserService.updateUserProfile(any),
      ).thenAnswer((_) async => null);
  ...
  group('Subscription management', () {
    test('addSubscription should add subscription to user', () async {
      ...
      when(mockUserService.fetchUserList()).thenAnswer((_) async => userList);
      when(mockUserService.setSubscription(any)).thenAnswer((_) async => null);
  ...
  group('Account management', () {
    test('deleteAccount should delete user account', () async {
      // Arrange
      when(mockFirebaseUser.delete()).thenAnswer((_) async => null);
      when(
        mockUserService.removeAccount('test-uid'),
      ).thenAnswer((_) async => null);
